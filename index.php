...
$karyawan = mysqli_query($koneksi, "SELECT * FROM santri");
$karyawan = mysqli_num_rows($karyawan);

// Pengeluaran Bulanan
$pengeluaran_bulanan = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total FROM pengeluaran WHERE MONTH(tgl_pengeluaran) = MONTH(CURDATE())");
$pengeluaran_bulanan = mysqli_fetch_array($pengeluaran_bulanan);
$total_pengeluaran_bulanan = $pengeluaran_bulanan['total'];

// Pengeluaran Mingguan
$pengeluaran_mingguan = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total FROM pengeluaran WHERE tgl_pengeluaran BETWEEN CURDATE() - INTERVAL 6 DAY AND CURDATE()");
$pengeluaran_mingguan = mysqli_fetch_array($pengeluaran_mingguan);
$total_pengeluaran_mingguan = $pengeluaran_mingguan['total'];

// Pemasukan Bulanan
$pemasukan_bulanan = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total FROM pemasukan WHERE MONTH(tgl_pemasukan) = MONTH(CURDATE())");
$pemasukan_bulanan = mysqli_fetch_array($pemasukan_bulanan);
$total_pemasukan_bulanan = $pemasukan_bulanan['total'];

// Pemasukan Mingguan
$pemasukan_mingguan = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total FROM pemasukan WHERE tgl_pemasukan BETWEEN CURDATE() - INTERVAL 6 DAY AND CURDATE()");
$pemasukan_mingguan = mysqli_fetch_array($pemasukan_mingguan);
$total_pemasukan_mingguan = $pemasukan_mingguan['total'];
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="exsport-semua.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        Rp.<?=number_format($pemasukan_bulanan['0'],2,',','.');?></div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                </div>
                            </div>
                        </div> &nbsp Hari ini : Rp.
                        <?php
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Pengeluaran
                                        (bulan ini)</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        Rp.<?=number_format($pengeluaran_bulanan['0'],2,',','.');?></div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="col">
						  ...
						  ?>
                                ...
                                <div class="progress-bar bg-<?=$warna?>" role="progressbar" style="width: 100%"
                                    aria-valuenow="<?=$value?>" aria-valuemin="0" aria-valuemax="100"><span><?=$value?>
                                        % </span></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Santri
                                    </div>
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item" href="pendapatan.php">Pemasukan</a>
